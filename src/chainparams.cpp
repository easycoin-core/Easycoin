...
{
    const char* pszTimestamp = "easycoin very fast to mining";
...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = 365 * 24 * 60 * 60; // 1 year
        ...
        vSeeds.push_back(CDNSSeedData("easycoin.hopto.org", "easycoin.hopto.org", true));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("easycoin.hopto.org", "easycoin.hopto.org"));
...
public:
    CRegTestParams() {
        ...
        genesis = CreateGenesisBlock(1487526785, 0, 0x207fffff, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe1e0d7228cd05442732e768670e417b3dc6367ab75c87f105ea0fdb5ee23d2a7"));
        assert(genesis.hashMerkleRoot == uint256S("0x4f67b77e0a5e9a263a6b6609ff1f64342ab192f1c65b2579fa909a78965de7df"));
