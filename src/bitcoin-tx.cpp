...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s easycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  easycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded easycoin transaction") + "\n" +
              "  easycoin-tx [options] -create [commands]   " + _("Create hex-encoded easycoin transaction") + "\n" +
              "\n";
