...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/easycoin-project/easycoin>";
    const std::string URL_WEBSITE = "<https://easycoin.org>";
